...
- Tidbyt Gen 2, Pitch.Page, Instawork, BareMinimum, SeeMe, MotherDuck
- Fireworks, Supermaven, Humane, Autograph, Nourish, Kinnect
- Dropbox Replay, Lightmatter, Instawork CREW, Monocraft
- Tanium, SignalWire, SoundCloud, Truework, UserGems
- Nana Pods, Forethought, Hallow, Vercel Launch Week
...
|------|---------------|-------------|
| ADVISE | $5,000 | 30-min consult, resource referrals |
| LAUNCH | $15,000 | Full production partnership |
| SCALING | $100-500k | Ongoing relationships |

**Pitch Packages** (from /pitch):
| Package | Price | Features |
|---------|-------|----------|
| PLUS | $37,500 | 3 premium add-ons |
| APEX | $50,000 | 6 premium add-ons |

Base pitch features: Script support, performance coaching, 4K cinema camera, teleprompter, premium lighting, branded title graphics, custom Pitch.Page URL
...
graph TB
    subgraph Public Site
        ...
        DESIGN[/design - Web Design Portfolio]
        DESIGNID[/design/id - Design Detail]
...
- Recommended tier (ADVISE/LAUNCH/SCALING)
...
// Create React wrapper components in src/components/animations/
```
