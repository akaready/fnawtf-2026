...
This animation creates an underline effect that expands from the center or side when hovered. It uses pure CSS with pseudo-elements (`::before` and `::after`) to create a smooth, performant transition without any JavaScript.
