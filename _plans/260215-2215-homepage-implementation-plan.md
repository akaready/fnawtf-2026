...
**Reference**: [`_assets/willem-loading-animation.md`](_assets/willem-loading-animation.md)
...
**Reference**: [`_assets/directional-button-hover.md`](_assets/directional-button-hover.md), [`_assets/burger-menu-button.md`](_assets/burger-menu-button.md)

### Desktop Navigation

- Centered layout
- Links: Home | Work | Services | Pricing | About
- Purple background buttons with directional fill animation
...
## Section 4: Locations Row

### Content

"San Francisco • Los Angeles • Austin • New York • Global"
...
## Section 8: Featured Work (Masonry Grid)
...
"like what you see? snag some time on our calendar."
