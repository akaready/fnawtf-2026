...
export async function submitIntakeForm(data: IntakeFormData) {
  ...
  await notifySlack({
    ...
    data: {
      ...
      timelineNotes: data.timeline_notes,
      pitch: data.pitch,
      phases: data.phases,
      experience: data.experience,
      experienceNotes: data.experience_notes,
      ...
      partners: data.partners,
      partnerDetails: data.partner_details,
      publicGoal: data.public_goal,
      internalGoal: data.internal_goal,
      emailListSize: data.email_list_size,
