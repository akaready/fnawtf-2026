...
/**
 * Demo5 — Refined linear layout
 * Single column (760px), dark default, Demo2 flow + Demo4 polish.
 * Dev toolbar for stage/discount toggling.
 */
...
export function Demo5({ data: _initialData }: { data: InvoiceData }) {
    ...
    <div className={`min-h-screen bg-admin-bg-base text-admin-text-primary ${lightMode ? 'cs-light' : ''}`}>
      ...
      <div className="max-w-[760px] mx-auto px-8 sm:px-12 py-14 space-y-10">
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-3 mb-4">
                    <div>
                      ...
                      {stage.paidAt && (
                        <p className="text-xs text-admin-text-dim mt-1 flex items-center gap-1">
                          {formatDate(stage.paidAt)}
        ...
        <div className="rounded-2xl bg-admin-bg-raised border border-admin-border py-14 text-center">
          ...
          {/* Related documents */}
          <div className="flex items-center justify-center gap-6 mt-8 pt-6 border-t border-admin-border mx-auto max-w-xs">
            <a
              href="#"
              className="inline-flex items-center gap-1.5 text-sm font-medium text-admin-text-muted hover:text-admin-text-primary transition-colors"
            >
