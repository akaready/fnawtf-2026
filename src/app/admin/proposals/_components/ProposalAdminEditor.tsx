          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              {proposal.generated_by && status === 'generated' && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-admin-full bg-admin-accent-bg text-accent text-admin-sm">
                  <Sparkles size={12} /> Generated by Friendly Bot
                </span>
              )}
            </div>
