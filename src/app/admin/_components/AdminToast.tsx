...
function ToastItem({ toast, onDismiss }: { toast: Toast; onDismiss: (id: number) => void }) {
  ...
  return (
    <motion.div
      ...
      className="flex items-center gap-3 bg-admin-bg-overlay border border-admin-border rounded-admin-xl shadow-xl backdrop-blur-sm pl-4 pr-3 py-4 border-l-2 border-l-admin-danger"
    >
