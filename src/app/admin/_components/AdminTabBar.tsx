...
export function AdminTabBar({ tabs, activeTab, onTabChange, actions, dividerAfter }: AdminTabBarProps) {
  return (
    <div className="flex-shrink-0 flex items-center gap-1 px-6 @md:px-8 h-[3rem] border-b border-admin-border bg-admin-bg-wash overflow-x-auto [&::-webkit-scrollbar]:hidden">
      {tabs.map((tab) => (
