...
function SortableDot({ id, rawColor, isActive, label, onClick }: {
  ...
  return (
    <div ref={setNodeRef} style={style} {...attributes} {...listeners} className="relative group/dot">
      <button
        onClick={onClick}
        className="flex items-center justify-center w-[30px] h-[30px] rounded-lg transition-all duration-200 hover:bg-admin-bg-hover cursor-grab active:cursor-grabbing"
      >
        <span
